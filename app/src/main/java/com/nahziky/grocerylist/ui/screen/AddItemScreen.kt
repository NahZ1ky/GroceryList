    ...
    Column(modifier = Modifier.padding(20.dp)) {
        ...
        /*ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
                ...
                onValueChange = { generalViewModel.updateCategoryTextBox(it) },
                label = { Text("Category") },
        ...
        // Add Item
        OutlinedTextField(
            value = uiState.productTextBoxValue,
            onValueChange = { generalViewModel.updateProductTextBox(it) },
            label = { Text("Product Name") }
        )

        // submit button
        Button(
            onClick = { generalViewModel.onSubmit() },
